...
def get_warmup_menu_keyboard():
    ...
    keyboard = [
        [InlineKeyboardButton("⚡ Быстрый прогрев", callback_data="quick_warmup")],
        [InlineKeyboardButton("🧠 Умный прогрев", callback_data="smart_warmup")],
        [InlineKeyboardButton("🎯 Прогрев по интересам", callback_data="interest_warmup_menu")],
        [InlineKeyboardButton("📊 Статус прогрева", callback_data="warmup_status")],
        [InlineKeyboardButton("⚙️ Настройки прогрева", callback_data="warmup_settings")],
